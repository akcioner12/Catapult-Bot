...
async def generate_instagram_caption(source_text: str, category: str, content_type: str) -> dict:
    ...
    finance_guard = (
        ...
        "БЕЗ обещаний прибыли, БЕЗ срочности, БЕЗ реферальных заработков, "
    ...
    ) if category in ("catapult", "forexbot") else ""
...
Подбери 10-15 хэштегов: смесь широких по теме и нишевых по конкретному посту.
