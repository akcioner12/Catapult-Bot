...
{"""
Кандидаты про Catapult Trade взяты из каналов, которые её продвигают — у них
рекламная подача, её НЕ наследуй. Пиши нейтрально, только факты/новости
платформы. БЕЗ обещаний прибыли или доходности, БЕЗ "лучший момент войти"/
срочности, БЕЗ реферальных заработков/процентов от команды, БЕЗ личных
заявлений о том, сколько заработано, БЕЗ прямых призывов зарегистрироваться
или вложить деньги — это именно то, за что Instagram уже ограничивал аккаунт
как подозрение в мошенничестве.""" if category == "catapult" else ""}
