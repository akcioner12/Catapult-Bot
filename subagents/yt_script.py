...
from subagents.rewriter import CLAUDE_API_KEY, CLAUDE_API_URL, _record_claude_error, NEUTRALITY_NOTE
...
Выбери ОДНУ самую резонансную, горячую историю из кандидатов выше и напиши сценарий именно про неё — не пытайся смешать несколько тем в одну. Если ни один кандидат не выглядит по-настоящему интересным, возьми {context} как тему в целом. Если самый резонансный кандидат завязан именно на специфически российских реалиях (см. ниже) — выбери следующий по резонансности кандидат вместо него.
