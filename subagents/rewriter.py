...
# Автор и аудитория — украинцы, не россияне: контент не должен упоминать
# Путина/ЦБ РФ/рубль и прочие специфически российские реалии как примеры.
NEUTRALITY_NOTE = (
    "ВАЖНО: не упоминай Путина, Центробанк России, российский рубль или другие "
    "специфически российские реалии как примеры — веди нейтрально, на "
    "международных примерах (USD, EUR, ФРС, ЕЦБ и т.п.)."
)
...
STYLE_GUIDE = f"""Ты — автор Telegram канала «Крипта, AI, Forex. Как заработать?».
