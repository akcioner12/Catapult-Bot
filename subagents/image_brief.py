...
async def generate_image_brief(post_text: str, category: str) -> str:
    category_style = {
        ...
        "poll":     "тёмный фон, смешение неоновых синих, оранжевых и фиолетовых акцентов, крипто/форекс/трейдинг символика, ощущение живого голосования и вовлечённости аудитории",
    }
