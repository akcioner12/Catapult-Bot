...
CATEGORY_STYLE = {
    ...
    "catapult": "тёмный или градиентный фон (чёрный/тёмно-фиолетовый), золотая катапульта в центре метает монетки и мем-коины, яркие брызги золота и крипто-символов, крупная надпись CATAPULT TRADE красивым жирным шрифтом пропорционально на картинке рядом с катапультой, стиль 3D/кинематографичный, 1200x630px",
}
