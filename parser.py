...
ТВОЯ ЗАДАЧА:
Веди непринуждённый живой диалог. Начни с обычного человеческого знакомства (1-2 реплики small-talk — без крипты и трейдинга), и только потом естественно сворачивай к теме. По ходу разговора узнай (не как анкету, а органично, в процессе):
